...
[
  {
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/92c952/ffffff&text=Product+1"
  },
  {
    "albumId": 1,
    "id": 2,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/771796/ffffff&text=Product+2"
  },
  {
    "albumId": 1,
    "id": 3,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/24f355/ffffff&text=Product+3"
  },
  {
    "albumId": 1,
    "id": 4,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/d32776/ffffff&text=Product+4"
  },
  {
    "albumId": 1,
    "id": 5,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/f66b97/ffffff&text=Product+5"
  },
  {
    "albumId": 1,
    "id": 6,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/56a8c2/ffffff&text=Product+6"
  },
  {
    "albumId": 1,
    "id": 7,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/b0f7cc/000000&text=Product+7"
  },
  {
    "albumId": 1,
    "id": 8,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/54176f/ffffff&text=Product+8"
  },
  {
    "albumId": 1,
    "id": 9,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/51aa97/ffffff&text=Product+9"
  },
  {
    "albumId": 1,
    "id": 10,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/810b14/ffffff&text=Product+10"
  },
  {
    "albumId": 1,
    "id": 11,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/1ee8a4/000000&text=Product+11"
  },
  {
    "albumId": 1,
    "id": 12,
    ...
    "thumbnailUrl": "https://dummyimage.com/150x150/66b7d2/ffffff&text=Product+12"
  },
  {
    "albumId": 1,
    "id": 13,
...
export function fetchProducts() {
  if (productsWithPrice.length === 0) {
    productsWithPrice = products.map((product, index) => {
      
      const newProduct = { ...product };
      
      // delete unused properties
      delete newProduct.albumId;
      delete newProduct.url;
      
      // random price between $10 to $100.00
      newProduct.price = Math.round(Math.random() * 9000) / 100 + 10;
      
      
      const colors = ['92c952', '771796', '24f355', 'd32776', 'f66b97', '56a8c2', 'b0f7cc', '54176f', '51aa97', '810b14', '1ee8a4', '66b7d2'];
      const colorIndex = index % colors.length;
      const color = colors[colorIndex];
      const textColor = ['b0f7cc', '1ee8a4', '24f355'].includes(color) ? '000000' : 'ffffff';
      
      newProduct.thumbnailUrl = `https://dummyimage.com/150x150/${color}/${textColor}&text=Product+${product.id}`;
